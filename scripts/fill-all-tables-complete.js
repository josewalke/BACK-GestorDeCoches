...
const generarAlquiler = (reservaId, vehiculoId, clienteId) => {
  ...
  return {
    ...
    nivel_combustible_salida: Math.floor(Math.random() * 100) + 1, // Entre 1 y 100
    km_entrada: null,
...
async function fillAllTablesComplete() {
  try {
...
if (require.main === module) {
  fillAllTablesComplete();
}

module.exports = { fillAllTablesComplete }; 